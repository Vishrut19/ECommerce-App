...
export default function ProductPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    return (
        <div className="container mx-auto px-4 py-24">
            <Link href="/tech" className="inline-flex items-center text-xs uppercase tracking-widest font-bold mb-12 hover:text-muted-foreground transition-colors group">
