...
export default function TechPage() {
    const { data: products, isLoading, error } = useProducts('tech');
    ...
    return (
        <div className="container mx-auto px-4 py-24">
            <div className="mb-16">
                ...
                <h1 className="text-5xl md:text-7xl font-bold tracking-tighter">FUTURE TECH</h1>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-16">
                {products?.map((product) => {
                    ...
                    return (
                        <Link href={`/tech/${product.id}`} key={product.id} className="group">
