...
CREATE TABLE "product_attribute_items" (
    ...
    CONSTRAINT "product_attribute_items_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "product_attribute_items" ADD CONSTRAINT "product_attribute_items_attributeId_fkey" FOREIGN KEY ("attributeId") REFERENCES "product_attributes"("id") ON DELETE CASCADE ON UPDATE CASCADE;
